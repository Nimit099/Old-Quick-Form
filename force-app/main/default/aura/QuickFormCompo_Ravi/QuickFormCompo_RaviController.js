        ...
        try {
            ...
            if (Fieldid == 'QFPAGEBREAK') {
                ...
                if (dataRef == "inner") {
                    ...
                    else if (classname == 'fullname cQuickformfieldcomponent1' || classname == 'datetime cQuickformfieldcomponent1' || classname == 'cQuickformfieldcomponent1' || classname == 'slds-form-element__label cQuickformfieldcomponent1' || classname == "slds-box slds-box_xx-small ratebox ratingstyle cQuickformfieldcomponent1") {
                        event.target.parentNode.parentNode.insertBefore(xc, event.target.parentNode);
                    } // for star rating field 
                    else if (classname == "ratingLabel") {
                    ...
                    else if (classname == 'fullname cQuickformfieldcomponent1' || classname == 'datetime cQuickformfieldcomponent1' || classname == 'slds-form-element__label cQuickformfieldcomponent1' || classname == 'cQuickformfieldcomponent1' || classname == "slds-box slds-box_xx-small ratebox ratingstyle cQuickformfieldcomponent1") {
        ...
        try {
            ...
            for (var dropzone of dropzoneloop) {
                ...
                if (dropzone.lastElementChild == null) {
                    ...
                    // console.log('u leave mouse');
                    // var g = dropzone.lastElementChild;

                    // console.log(dropzone.lastElementChild);
                    // console.log(dropzone.lastElementChild.classList);



                    // dropzone.lastElementChild.style.opacity = 1;
                    // dropzone.style.opacity = 1;
