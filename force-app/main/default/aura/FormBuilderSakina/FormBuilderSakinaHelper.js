({
    ...
    // try {
    //     event.preventDefault();
    // var getValidayonBar = document.querySelector('.fieldDiv2');
    // getValidayonBar.style.display = 'none';
    ...
    // switch (tab.get('v.id')) {
    //     case 'myPreviewForm':
    //         this.injectComponent('c:PreviewFormComponent', tab);
    //         break;
    ...
    //     if (getevent == 'Preview') {
    //         const pre = component.find('precmp');
    //         pre.fetchForm();
    //     }

    //     if (getevent == 'Object Mapping') {
    //         const objcmp = component.find('objcmp');
    //         objcmp.fetchObj();
    //     }

    //     console.log({ getevent });
    //     if (getevent == 'Notification') {
    //         const notification = component.find('notmcp');
    //         console.log({ notification });
    //         notification.loadEmailRecipient();
    //     }

    //     if (getevent == 'Notification' || getevent == 'Thank you page' || getevent == 'Preview' || getevent == 'Publish' || getevent == 'Object Mapping') {
    ...
    //         "FormId": component.get('v.FormIdencod'),
    ...
    //                 if (recevi_mail_str == undefined){
    //                     component.set("v.spinner",false);
    //                 }
    //                 emailRecipientList.recever_mailid = JSON.parse(recevi_mail_str);
    //                 console.log('test data for recipient ::');
    ...
    handleCss: function(component, event, helper) {
        try {
            ...
            if (getformWidth == '100' || getformWidth == '') {
                r.style.setProperty('--boxShadow', '0 19px 38px rgba(0, 0, 0, 0.30), 0 15px 12px rgba(0, 0, 0, 0.22)');
            } else {
                r.style.setProperty('--boxShadow', '');
            ...
            if (gethead == '' || gethead == null) {
                ...
                r.style.setProperty('--formPaddingTop', gethead + '5%');
            ...
            if (getfoot == '' || getfoot == null) {
                r.style.setProperty('--formPaddingBottom', '30%');

            } else {
                r.style.setProperty('--formPaddingBottom', getfoot + '30%');
            ...
            if (getleft == '' || getleft == null) {
                ...
                r.style.setProperty('--formPaddingLeft', getleft + '5%');
            ...
            if (getright == '' || getright == null) {
                ...
                r.style.setProperty('--formPaddingRight', getright + '5%');
            }
