({
    ...
    onDragStart: function(form, event, helper, component) {
        try {
            ...
            if (x == null) {
                ...
                //         dropzone.style.padding = '2%';
                //         dropzone.style.left = '1%';
                //         dropzone.style.border = "1px dashed #3298c8";
                //         dropzone.style.margin = '0 2%';
    ...
    handleActiveTab: function(component, event, helper) {
        console.log({ event });
        var getDiv = document.querySelector('.EditFormContent');
